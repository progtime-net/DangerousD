...
internal class WinGUI : AbstractGui
{
    ...
    protected override void CreateUI()
    {
        ...
        Elements.Add(new Label(Manager) { rectangle = new Rectangle((wigth - 50) / 2, (height - 50) / 2 - 160, 50, 50), text = "You escaped!", mainColor = Color.Transparent, scale = 0.7f, fontName = "ButtonFont", fontColor = Color.White });
